...
socket.on('join_room_response',function(payload){
	...
	var newHTML = '<p><font color="lime"><b>'+payload.username+'</b> entered the room</font></p>';
	var newNode = $(newHTML);
	newNode.hide();
...
socket.on('player_disconnected',function(payload){
	...
	var newHTML = '<p><font color="red"><b>'+payload.username+'</b> left the room</font></p>';
	var newNode = $(newHTML);
	newNode.hide();
	$('#messages').prepend(newNode);
	newNode.slideDown(1000);
...
$(function(){
	...
	$('#quit').append('<a href="lobby.html?username='+username+' " class="btn btn-lg btn-outline-warning" role="button" aria-pressed="true">Quit</a>');
